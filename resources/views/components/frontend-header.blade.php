        ...
        <div class="flex items-center justify-between py-2.5 lg:py-4.5">
            ...
            <div class="flex flex-row justify-center items-center md:gap-4 gap-2.5">
                <div class="md:flex hidden gap-3">
                    @auth
                        <a href="https://chromewebstore.google.com/detail/leadcliq/hoeafjdokgpbheobiblmioobkcgenfjp" target="_blank" class="bg-dark text-white hover:text-primary hover:bg-dark rounded-2xl px-7.5 py-3.5 font-medium transition-all duration-300">

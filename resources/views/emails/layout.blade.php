...
<body style="margin:0;padding:0;background-color:#f6f7fb;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;">
    <span style="display:none;max-height:0;overflow:hidden;mso-hide:all;">@yield('preheader', '')</span>
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f6f7fb;border-collapse:collapse;">
        <tr>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;border-collapse:collapse;">
                    ...
                    <tr>
                        <td style="background-color:#061d19;padding:20px 24px 28px;text-align:center;">
                            <div style="margin:0 auto 12px;line-height:1;">
                                <img
                                    src="{{ asset('images/leadcliq-dark-logo.png') }}"
                                    alt="{{ config('app.name') }}"
                                    height="28"
                                    style="display:block;height:28px;max-width:100%;margin:0 auto;border:0;outline:none;text-decoration:none;"
                                >
                            </div>
                    ...
                    <tr>
                        <td style="background-color:#ffffff;padding:32px 28px;border-radius:0 0 12px 12px;border:1px solid #e6e8ef;border-top:none;">

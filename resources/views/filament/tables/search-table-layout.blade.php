{{-- 
    Reusable custom table layout with floating search
    Use this in any ListRecords page by setting: protected string $view = 'filament.tables.search-table-layout';
--}}

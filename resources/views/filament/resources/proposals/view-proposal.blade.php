                ...
                <div class="p-5 bg-[#f2f8ff] border border-gray-200 rounded-xl shadow-sm dark:bg-gray-900 dark:border-gray-800" 
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <button 
                            type="button"
                            @click="copyText"
                            class="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-[#fff] border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700 transition-colors"
                        >
